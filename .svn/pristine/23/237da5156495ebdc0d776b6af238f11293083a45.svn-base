<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:94:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\study\edit_stage.html";i:1504533884;s:91:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\header.html";i:1504533884;s:88:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\nav.html";i:1504533884;s:94:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\path_link.html";i:1504533884;s:91:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\footer.html";i:1504533884;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/study/saveStage'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">

                                <input type="hidden" name="stage_id" value="<?php echo $stageInfo['stage_id']; ?>">
                                <div class="control-group">
                                    <label class="control-label">阶段名称：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" placeholder="请输入阶段名称" value="<?php echo $stageInfo['stage_name']; ?>" name="stage_name" data-required="1" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                            <option value=""></option>
                                            <option value="1" <?php if(1 == $stageInfo['status']): ?>selected<?php endif; ?>>在授</option>
                                            <option value="2" <?php if(2 == $stageInfo['status']): ?>selected<?php endif; ?>>下架</option>
                                        </select>
                                    </div>
                                </div>
