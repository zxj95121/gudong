                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑会员优惠卷信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/UserCoupon/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="backUrl" value="<?php echo $backUrl; ?>">
                                <input type="hidden" name="userCoupon_id" value="<?php echo (isset($info['userCoupon_id']) && ($info['userCoupon_id'] !== '')?$info['userCoupon_id']:''); ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="user_no" data-placeholder="-请选择用户-" tabindex="1">
                                            ...
                                            <option value="<?php echo (isset($user['user_no']) && ($user['user_no'] !== '')?$user['user_no']:''); ?>"  <?php if(!empty($info)): if($info['user_no'] == $user['user_no']): ?>selected<?php endif; endif; ?>><?php echo $user['user_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">优惠卷：<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="coupon" data-placeholder="-请选择优惠卷-" tabindex="1">
                                            <option value=""></option>
                                            <?php foreach($couponList as $coupon): ?>
                                            <option value="<?php echo (isset($coupon['coupon_id']) && ($coupon['coupon_id'] !== '')?$coupon['coupon_id']:''); ?>,<?php echo (isset($coupon['coupon_price']) && ($coupon['coupon_price'] !== '')?$coupon['coupon_price']:''); ?>"  <?php if(!empty($info)): if($info['coupon_id'] == $coupon['coupon_id']): ?>selected<?php endif; endif; ?> ><?php echo (isset($coupon['coupon_name']) && ($coupon['coupon_name'] !== '')?$coupon['coupon_name']:''); ?>，备注：<?php echo $coupon['note']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="store_id" data-placeholder="-请选择门店-" tabindex="1">
                                            ...
                                            <option value="<?php echo (isset($store['store_id']) && ($store['store_id'] !== '')?$store['store_id']:''); ?>"  <?php if(!empty($info)): if($info['store_id'] == $store['store_id']): ?>selected<?php endif; endif; ?> ><?php echo (isset($store['store_name']) && ($store['store_name'] !== '')?$store['store_name']:''); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" value="<?php if(isset($info)): ?><?php echo $info['start_time']; endif; ?>" name="start_time" class="span6 m-wrap"
                                               placeholder="请输入开始时间" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" value="<?php if(isset($info)): ?><?php echo $info['end_time']; endif; ?>" name="end_time" class="span6 m-wrap"
                                               placeholder="请输入结束时间" >
                                    </div>
                                </div>
