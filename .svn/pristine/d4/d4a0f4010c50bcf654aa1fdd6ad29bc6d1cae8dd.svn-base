...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/Room/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Room/index'); ?>" id='searchForm' method='get'>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Room/operation_info',['room_id'=>$info['room_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Room/update_status',['room_id'=>$info['room_id']]); ?>">
