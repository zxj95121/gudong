                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑充值套餐信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/ChargePackage/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="chargePackage_id" value="<?php echo (isset($info['chargePackage_id']) && ($info['chargePackage_id'] !== '')?$info['chargePackage_id']:''); ?>">
                                <input type="hidden" name="backUrl" value="<?php echo $backUrl; ?>">

                                <div class="control-group">
                                    <label class="control-label">套餐名称：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo (isset($info['package_name']) && ($info['package_name'] !== '')?$info['package_name']:''); ?>" name="package_name" class="span6 m-wrap"
                                               placeholder="请输入套餐名称" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">金额(元)：<span class="required">*</span></label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?php if(isset($info)): ?><?php echo $info['money_given']/100; endif; ?>" name="money_given" class="span6 m-wrap"
                                               placeholder="请输入赠送金额" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">总金额(元)：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="<?php if(isset($info)): ?><?php echo $info['total_money']/100; endif; ?>" name="total_money" class="span6 m-wrap"
                                               placeholder="请输入价格" >
                                    </div>
                                </div>
