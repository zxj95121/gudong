                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/human/staff'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo !empty($staff['gender']) && $staff['gender']==1?'男':($staff['gender'] == 2?'女':'未知'); ?></td>
                                    <td>
                                        <?php if(!empty($staff['header_img'])): ?>
                                            <img src="<?php echo $staff['header_img']; ?>" onclick="showImg(this)">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <span class="btn <?php if($staff['status']==3): ?>red<?php elseif($staff['status']==1): ?>green<?php else: ?>blue<?php endif; ?>">
                                            <?php echo showStatus($staff['status'],'离职,正常,休假:3,1,2'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="btn blue"  onclick="editStaff(<?php echo $staff['staff_id']; ?>)" style="cursor: pointer;">
...
<script type="text/javascript">
    function editStaff(staff_id){
        window.location.href = "<?php echo url('human/editStaff'); ?>?staff_id="+staff_id;
    }
