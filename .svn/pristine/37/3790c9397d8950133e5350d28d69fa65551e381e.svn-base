                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>教练评论列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Technician/comment_list'); ?>" id='searchForm' method='get'>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><span class="show_content">
                                        <p title="<?php echo strip_tags($info['content'])?>"><?php echo mb_substr(strip_tags($info['content']),0,20,'UTF-8')?></p>
                                    </span></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Technician/update_comment_status',['comment_id'=>$info['comment_id']]); ?>">
