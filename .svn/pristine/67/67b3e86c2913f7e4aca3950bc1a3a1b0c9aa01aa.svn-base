                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>项目订单列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Order/index'); ?>" id='searchForm' method='get'>
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>新订单</option>
                                        <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>核销成功</option>
                                        <option value="3" <?php if($status == 3): ?>selected<?php endif; ?>>取消订单</option>
                                    </select>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    <td><?php echo $key; ?></td>
                                    <!--`status` tinyint(4) DEFAULT NULL COMMENT '状态 1未支付，2待消费，3待评价 4 已完成',-->
                                    <!--`add_ts` int(11) DEFAULT NULL COMMENT '添加时间',-->
                                    <!--`pay_type` tinyint(4) DEFAULT NULL COMMENT '支付类型 1微信 2余额 3积分',-->
                                    <!--`price` int(11) DEFAULT NULL COMMENT '价格(RMB)',-->
                                    <!--`points` int(11) DEFAULT NULL COMMENT '价格(积分)',-->
                                    <!--`time` int(11) DEFAULT NULL COMMENT '服务时间',-->
                                    <!--`start_time` int(11) DEFAULT NULL COMMENT '开始时间',-->
                                    <!--`end_time` int(11) DEFAULT NULL COMMENT '结束时间',-->
                                    <!--`total_price` int(11) DEFAULT NULL COMMENT '总价(应付款)',-->
                                    <!--`actual_price` int(11) DEFAULT NULL COMMENT '实际付款',-->
                                    <!--`type` tinyint(4) DEFAULT NULL COMMENT '类型1 常规 2 兑换',-->
                                    ...
                                    <td><span><?php echo showstatus($info['status'],'新订单,核销成功,取消订单:1,2,3'); ?></span></td>
                                    <td>
...
<script>
    ...
    $('.validation').click(function () {
         ...
         if(val.length==8){
             window.location.href="<?php echo url('admin/Order/order_validation'); ?>?order_no="+val;
         }else {
             alert('您输入编码有误');
         }
    })
