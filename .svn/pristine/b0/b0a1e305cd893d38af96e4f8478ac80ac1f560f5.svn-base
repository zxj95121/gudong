                ...
                <div class="span12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/UserCharge/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="charge_id" value="<?php echo (isset($info['charge_id']) && ($info['charge_id'] !== '')?$info['charge_id']:''); ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="user_no" data-placeholder="-请选择用户-" tabindex="1">
                                            ...
                                            <option value="<?php echo $user['user_no']; ?>" <?php if(!empty($info)): if($info['user_no'] == $user['user_no']): ?>selected<?php endif; endif; ?>><?php echo $user['mobile']; ?><?php echo $user['user_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="chargePackage_id" data-placeholder="-请选择充值套餐-" tabindex="1">
                                            <option value=""></option>
                                            <?php foreach($packageList as $package): ?>
                                            <option value="<?php echo $package['chargePackage_id']; ?>" <?php if(!empty($info)): if($info['chargePackage_id'] == $package['chargePackage_id']): ?>selected<?php endif; endif; ?>><?php echo $package['package_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?php if(isset($info)): ?><?php echo $info['money']/100; endif; ?>" name="money" class="span6 m-wrap"
                                               placeholder="请输入总金额" >
                                    </div>
                                </div>
