<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:95:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\stock\edit_manage.html";i:1504540016;s:91:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\header.html";i:1504533884;s:88:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\nav.html";i:1504533884;s:94:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\path_link.html";i:1504533884;s:91:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/admin\view\Default\common\footer.html";i:1504533884;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/stock/saveManage'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">

                                
                                <div class="control-group">
                                    <label class="control-label">课程名称：<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="course_id" data-placeholder="-请选择课程名称-" tabindex="1">
                                            <option value=""></option>
                                            <?php foreach($allCourse as $key=>$value): if($manageInfo['course_id'] == $value['course_id']): ?>
                                            <option value="<?php echo $value['course_id']; ?>" selected="selected"><?php echo $value['course_name']; ?></option>
                                            <?php else: ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="store_id" data-placeholder="-请选择所属门店-" tabindex="1">
                                            <option value=""></option>
                                            <?php foreach($allStore as $key=>$value): if($manageInfo['store_id'] == $value['store_id']): ?>
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="请输入练习册总数" value="<?php echo $manageInfo['manage_count']; ?>" name="manage_count" data-required="1" class="span6 m-wrap"/>
                                        <input type="hidden" name="alter_before" value="<?php echo $manageInfo['manage_count']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                            <option value=""></option>
                                            <option value="1" <?php if(1 == $manageInfo['status']): ?>selected<?php endif; ?>>正常</option>
                                            <option value="2" <?php if(2 == $manageInfo['status']): ?>selected<?php endif; ?>>下架</option>
                                        </select>
                                    </div>
                                </div>
