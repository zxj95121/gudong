<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\Technician\index.html";i:1506689369;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\header.html";i:1507896678;s:75:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\nav.html";i:1508293702;s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:89:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\table\table_thead.html";i:1504065964;s:76:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\page.html";i:1505728701;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\footer.html";i:1507542266;s:82:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\showBigImg.html";i:1505194866;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/Technician/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Technician/index'); ?>" id='searchForm' method='get'>
                                    <select class="select_info chosen" data-with-diselect="1" name="technician_id" data-placeholder="-请选择姓名-" tabindex="1">
                                        <option value=""></option>
                                        <?php foreach($technicianList as $technician): ?>
                                        <option value="<?php echo $technician['technician_id']; ?>" <?php if($technician_id == $technician['technician_id']): ?>selected<?php endif; ?>><?php echo $technician['technician_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <select class="select_info chosen" data-with-diselect="1" name="gender" data-placeholder="-请选择性别-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if($gender == 1): ?>selected<?php endif; ?>>男</option>
                                        <option value="2" <?php if($gender == 2): ?>selected<?php endif; ?>>女</option>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><span><?php echo showstatus($info['gender'],'男,女:1,2'); ?></span></td>
                                    <td><?php echo $info['age']; ?></td>
                                    <td>
                                        <?php if(!empty($info['head_img'])): ?>
                                        <img src="<?php echo \think\Config::get('cms_upload'); ?><?php echo $info['head_img']; ?>" class="showImg" >
                                        <?php else: ?>
                                        <img src="/static/admin/image/notKnow.jpg" class="showImg">
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo $info['technician_tel']; ?></td>
                                    <td><?php echo $info['technician_title']; ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Technician/operation_info',['technician_id'=>$info['technician_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Technician/update_status',['technician_id'=>$info['technician_id']]); ?>">
...
<script>
    $('.chosen[name="technician_id"]').change(function () {
        return $('#searchForm').submit();
    })

    $('.chosen[name="gender"]').change(function () {
        return $('#searchForm').submit();
    })
