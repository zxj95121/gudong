<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:77:"C:\wamp64\www\anmo\public/../application/admin\view\Default\Points\index.html";i:1506761270;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\header.html";i:1509103829;s:75:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\nav.html";i:1508293702;s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:90:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\table\table_thead2.html";i:1506684176;s:76:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\page.html";i:1505728701;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\footer.html";i:1507542266;s:82:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\showBigImg.html";i:1509018234;}*/ ?>
 <!DOCTYPE html>
<head>
    <meta charset="utf-8" />
...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <!--<a href="<?php echo url('admin/PointsUpdateManage/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>-->
            <div class="row-fluid" style="margin-top: 10px;">
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>会员积分变动列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Points/index'); ?>" id='searchForm' method='get'>
                                    <select class="select_info chosen" data-with-diselect="1" name="user_no" data-placeholder="-请选择会员-" tabindex="1">
                                        <option value=""></option>
                                        <?php foreach($userList as $user): ?>
                                        <option value="<?php echo $user['user_no']; ?>" <?php if($user_no == $user['user_no']): ?>selected<?php endif; ?>><?php echo $user['mobile']; ?>,<?php echo $user['user_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="type" data-placeholder="-请选择类型-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if($type == 1): ?>selected<?php endif; ?>>增加积分</option>
                                        <option value="2" <?php if($type == 2): ?>selected<?php endif; ?>>减少积分</option>
                                    </select>
    ...
    <?php foreach($my_rule as $k=>$v): if($k==0): ?>
        ...
        <?php endif; endforeach; ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><span><?php echo showstatus($info['type'],'增加积分,减少积分:1,2'); ?></span></td>
                                    <td><?php echo $info['num']; ?></td>
                                    <td><span class="show_content">
                                        <p title="<?php echo strip_tags($info['note'])?>"><?php echo mb_substr(strip_tags($info['note']),0,20,'UTF-8')?></p>
                                    </span></td>
