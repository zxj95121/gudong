...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/SchedulingManage/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/SchedulingManage/operation_info',['id'=>$info['id']]); ?>">修改</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
