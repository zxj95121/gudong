                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/human/attendance'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="subject" data-placeholder="-请选择科目-" tabindex="1">
                                        <option value=""></option>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <?php foreach($attendanceList as $key=>$attendance): ?>
                                <tr class="odd gradeX">
                                    <td><?php echo $key+1; ?></td>
                                    <td><?php echo $attendance['student_name']; ?></td>
                                    <td><?php echo $attendance['student_no']; ?></td>
                                    <td><?php echo $attendance['staff_name']; ?></td>

                                    <td><?php echo $attendance['subject_name']; ?></td>
                                    <td><?php echo $attendance['course_name']; ?></td>
                                    <td><?php echo $attendance['add_ts']; ?></td>
