...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $info['total_money']/100; ?>元</td>
                                    <td><?php echo $info['total_points']; ?></td>
                                    <td><?php echo $info['points_available']; ?></td>
