...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/RelProjectTechnician/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加关联</a>
            <div class="row-fluid" style="margin-top: 10px;">
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>关联信息列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/RelProjectTechnician/index'); ?>" id='searchForm' method='get'>
                                    <select class="select_info chosen" data-with-diselect="1" name="store_id" data-placeholder="-请选择房间-" tabindex="1">
                                        <option value=""></option>
                                        <?php foreach($roomList as $room): ?>
                                        <option value="<?php echo $room['room_id']; ?>" <?php if(!empty($room_id)): if($room_id == $room['room_id']): ?>selected<?php endif; endif; ?>><?php echo $room['room_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="technician_id" data-placeholder="-请选择技师-" tabindex="1">
                                        <option value=""></option>
                                        <?php foreach($technicianList as $technician): ?>
                                        <option value="<?php echo $technician['technician_id']; ?>" <?php if(!empty($technician_id)): if($technician_id == $technician['technician_id']): ?>selected<?php endif; endif; ?>><?php echo $technician['technician_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/RelProjectTechnician/operation_info',['orderTechnician_id'=>$info['orderTechnician_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/RelProjectTechnician/update_status',['orderTechnician_id'=>$info['orderTechnician_id']]); ?>">
...
<script>
    $('.chosen[name="room_id"]').change(function () {
        return $('#searchForm').submit();
    })
