                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑增值服务/礼物商品信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/ValueService/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="backUrl" value="<?php echo $backUrl; ?>">
                                <input type="hidden" name="valueService_id" value="<?php echo (isset($info['valueService_id']) && ($info['valueService_id'] !== '')?$info['valueService_id']:''); ?>">


                                <div class="control-group">
                                    <label class="control-label">名　　称：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo (isset($info['valueService_name']) && ($info['valueService_name'] !== '')?$info['valueService_name']:''); ?>" name="valueService_name" class="span6 m-wrap"
                                               placeholder="请输入服务名称" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">价格(积分)：<span class="required">*</span></label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label">价格(元)：<span class="required">*</span></label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="type" data-placeholder="-选择服务类型-" tabindex="1">
                                            <option value=""></option>
                                            <option value="1" <?php if(isset($info)): if(1 == $info['type']): ?>selected<?php endif; endif; ?>>增值服务</option>
                                            <option value="2" <?php if(isset($info)): if(2 == $info['type']): ?>selected<?php endif; endif; ?>>礼物商品</option>
                                        </select>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                error: function (returndata) {
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?php echo (isset($info['note']) && ($info['note'] !== '')?$info['note']:''); ?>" name="note" class="span6 m-wrap"
                                               placeholder="请输入备注" >
                                    </div>
                                </div>
