<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"G:\phpstudy\phpstudy\WWW\tianma\public/../application/index\view\Default\parents\msg_center.html";i:1504533869;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="hisContainer">
			<?php if(!empty($msg)): foreach($msg as $key=>$item): ?>
                <div class="hisMsg">
