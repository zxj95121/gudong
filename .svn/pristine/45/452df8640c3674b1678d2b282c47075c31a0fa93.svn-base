...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/Store/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Store/index'); ?>" id='searchForm' method='get'>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><span><?php echo showstatus($info['discount_type'],'新店促销,打折优惠:1,2'); ?></span></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Store/operation_info',['store_id'=>$info['store_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Store/update_status',['store_id'=>$info['store_id']]); ?>">
