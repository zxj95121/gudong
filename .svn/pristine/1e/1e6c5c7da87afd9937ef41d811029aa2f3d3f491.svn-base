<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"C:\wamp64\www\anmo\public/../application/admin\view\Default\power\edit_role.html";i:1505728702;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\header.html";i:1506495541;s:75:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\nav.html";i:1505728701;s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\footer.html";i:1505728701;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑角色信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/power/saveRole'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">

                                <input type="hidden" name="role_id" value="<?php echo $role['role_id']; ?>">
                                <div class="control-group">
                                    <label class="control-label">角色名称：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo $role['role_name']; ?>" name="role_name" data-required="1" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                            <option value=""></option>
                                            <option value="1" <?php if(1 == $role['status']): ?>selected<?php endif; ?>>正常</option>
                                            <option value="2" <?php if(2 == $role['status']): ?>selected<?php endif; ?>>关闭</option>
                                        </select>
                                    </div>
                                </div>
