                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>预约订单列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Order/arrange'); ?>" id='searchForm' method='get'>

                                    <input type="text" name="arrange_no"  autofocus="autofocus" class='m-wrap' placeholder="请输入预约编号"
                                           value="<?php echo (isset($arrange_no) && ($arrange_no !== '')?$arrange_no:''); ?>">
                                    <div class="btn-group"  style="margin-top:-26px!important;">
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo date('Y- m-d H:i',$info['start_time']); ?>--<?php echo date('m-d H:i',$info['end_time']); ?></td>

                                    <td><?php echo date('Y-m-d H:i:s',$info['add_ts']); ?></td>
                                    <td><span><?php echo showstatus($info['status'],'待消费,待评价,已完成:1,2,3'); ?></span></td>
                                    <td>
                                    </td>
...
<script>
    ...
    $('.validation').click(function () {
        ...
        if(val.length==4){
            window.location.href="<?php echo url('admin/Order/arrange_validation'); ?>?arrange_no="+val;
        }else {
            alert('您输入编码有误');
        }
    })
