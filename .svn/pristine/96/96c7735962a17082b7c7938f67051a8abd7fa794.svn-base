...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/UserRecharge/operation_info'); ?>" class="btn green"></i>添加线下充值记录</a>
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/UserRecharge/index'); ?>" id='searchForm' method='get'>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $info['moneyC']; ?></td>
                                    <td><?php echo $info['moneyS']; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/UserRecharge/update_info',['id'=>$info['id']]); ?>">更改线下充值信息</li>
                                            </ul>
                                        </div>
                                        <?php endif; ?>
                                    </td>
