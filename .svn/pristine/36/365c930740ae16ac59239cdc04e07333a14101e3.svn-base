                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>科目列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/study/subject'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="chzn-container" style="float: left;margin-right: 15px;">
                                        <input type="text" maxlength="100" name="subject_name" value="<?php echo $subject_name; ?>" style="height:24px;font-size:12px;" placeholder="-科目名称-"/>
                                    </div>
                                    ...
                                    <div style="float:right;">
                                        <input type="button" onclick="editSubject(0)" class="btn green" value="添　加"/>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <?php foreach($subjectList as $key=>$subject): ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            周一:<?php echo $subject['week_day1']; ?>&nbsp;
                                            周二:<?php echo $subject['week_day2']; ?>&nbsp;
                                            周三:<?php echo $subject['week_day3']; ?>&nbsp;
                                            周四:<?php echo $subject['week_day4']; ?>&nbsp;
                                            周五:<?php echo $subject['week_day5']; ?>&nbsp;
                                            周六:<?php echo $subject['week_day6']; ?>&nbsp;
                                            周日:<?php echo $subject['week_day7']; ?>
                                        </td>
                                        <td>
                                            <span class="btn <?php if($subject['status']==1): ?>green<?php else: ?>red<?php endif; ?>">
                                                <?php echo showStatus($subject['status'],'在授,下架:1,2'); ?>
                                            </span>
                                        </td>
                                        <td>
                                           <span class="btn blue"  onclick="editSubject(<?php echo $subject['subject_id']; ?>)" style="cursor: pointer;">
...
<script type="text/javascript">
    function editSubject(subject_id){
        window.location.href = "<?php echo url('Study/editSubject'); ?>?subject_id="+subject_id;
    }
</script>
    </div>
