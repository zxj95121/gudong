<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:100:"C:\wamp64\www\anmo\public/../application/admin\view\Default\RelProjectTechnician\operation_info.html";i:1506609797;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\header.html";i:1506495541;s:75:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\nav.html";i:1505728701;s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\footer.html";i:1507542266;s:82:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\showBigImg.html";i:1505194866;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑关联信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/RelProjectTechnician/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="orderTechnician_id" value="<?php echo (isset($info['orderTechnician_id']) && ($info['orderTechnician_id'] !== '')?$info['orderTechnician_id']:''); ?>">
                                <input type="hidden" name="backUrl" value="<?php echo $backUrl; ?>">

                                <div class="control-group">
                                    <label class="control-label">房&nbsp;&nbsp;&nbsp;间：<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="room_id" data-placeholder="-请选择房间-" tabindex="1">
                                            <option value=""></option>
                                            <?php foreach($roomList as $room): ?>
                                            <option value="<?php echo $room['room_id']; ?>" <?php if(!empty($info)): if($info['room_id'] == $room['room_id']): ?>selected<?php endif; endif; ?>><?php echo $room['room_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">技&nbsp;&nbsp;&nbsp;师：<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="technician_id" data-placeholder="-请选择技师-" tabindex="1">
                                            ...
                                            <option value="<?php echo $technician['technician_id']; ?>" <?php if(!empty($info)): if($info['technician_id'] == $technician['technician_id']): ?>selected<?php endif; endif; ?>><?php echo $technician['technician_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
