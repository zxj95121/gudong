<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:86:"C:\wamp64\www\gudong\public/../application/admin\view\Default\User\operation_info.html";i:1509197704;s:80:"C:\wamp64\www\gudong\public/../application/admin\view\Default\common\header.html";i:1509778584;s:77:"C:\wamp64\www\gudong\public/../application/admin\view\Default\common\nav.html";i:1509606029;s:83:"C:\wamp64\www\gudong\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:98:"C:\wamp64\www\gudong\public/../application/admin\view\Default\common\file_upload\image_upload.html";i:1509781521;s:80:"C:\wamp64\www\gudong\public/../application/admin\view\Default\common\footer.html";i:1509674660;s:84:"C:\wamp64\www\gudong\public/../application/admin\view\Default\common\showBigImg.html";i:1509018234;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/User/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                  <label class="control-label">用户姓名：<span class="required">*</span></label>
                                    <div class="controls">
                                     <input type="text" value="<?php echo (isset($info['user_name']) && ($info['user_name'] !== '')?$info['user_name']:''); ?>" name="user_name" class="span6 m-wrap"
                                           placeholder="请输入用户姓名" >
                                </div>
                              </div>
            ...
            $.ajax({
                ...
                error: function (returndata) {
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" value="<?php echo (date('Y-m-d',$info['birthday']) ?: ''); ?>" name="birthday" class="span6 m-wrap"
                                               placeholder="请输入生日" >
                                    </div>
                                </div>
