...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/Coupon/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Coupon/index'); ?>" id='searchForm' method='get'>

                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if(isset($status)): if($status == 1): ?>selected<?php endif; endif; ?>>可用</option>
                                        <option value="2" <?php if(isset($status)): if($status == 2): ?>selected<?php endif; endif; ?>>不可用</option>
                                    </select>
                                    <select class="select_info chosen" data-with-diselect="1" name="coupon_type" data-placeholder="-请选择优惠卷类型-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if(isset($coupon_type)): if($coupon_type == 1): ?>selected<?php endif; endif; ?>>生日优惠</option>
                                        <option value="2" <?php if(isset($coupon_type)): if($coupon_type == 2): ?>selected<?php endif; endif; ?>>专享优惠</option>
                                        <option value="3" <?php if(isset($coupon_type)): if($coupon_type == 3): ?>selected<?php endif; endif; ?>>新手优惠</option>
                                    </select>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    <td><?php echo $key; ?></td>
                                    <td><?php echo showstatus($info['coupon_type'],'生日优惠券,专享优惠,新手优惠:1,2,3'); ?></td>
                                    <td><?php echo $info['coupon_name']; ?></td>
                                    <td><?php echo $info['coupon_no']; ?></td>
                                    <td><?php echo $info['coupon_price']/100; ?>元</td>
                                    <td><?php echo $info['expire_ts']; ?>天</td>
                                    <td><?php echo $info['note']; ?></td>
                                    <td><span><?php echo date('Y-m-d H:i:s',$info['add_ts']); ?></span></td>
                                    <td><span><?php echo showstatus($info['status'],'可用,不可用:1,2'); ?></span></td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Coupon/operation_info',['coupon_id'=>$info['coupon_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Coupon/update_status',['coupon_id'=>$info['coupon_id']]); ?>">
...
<script>
    ...
    $('.chosen[name="coupon_type"]').change(function () {
        return $('#searchForm').submit();
    })
