...
<body>
    <div style="text-align: center;padding-top: 150px;">
        ...
        <div>
            {if $msg=='余额不足'}
            <button class="btn" style="width:60%;font-size: 2.5rem;margin-top:4rem;background: #df3361;height:90px;line-height:46px;box-shadow: 2px 2px 6px #666;" onclick="window.location.href='{:url('index/index/user_wallet')}'">去充值</button>
            {/if}
            <br/>
