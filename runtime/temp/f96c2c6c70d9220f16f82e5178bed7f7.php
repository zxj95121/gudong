                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>叫车列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Car/index'); ?>" id='searchForm' method='get'>

                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>可用</option>
                                        <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>不可用</option>
                                    </select>
                                    <select class="select_info chosen" data-with-diselect="1" name="store_id" data-placeholder="-请选择门店-" tabindex="1">
                                        <option value=""></option>
                                        <?php foreach($storeList as $store): ?>
                                        <option value="<?php echo (isset($store['store_id']) && ($store['store_id'] !== '')?$store['store_id']:''); ?>" <?php if(isset($store_id)): if($store_id == $store['store_id']): ?>selected<?php endif; endif; ?>><?php echo $store['store_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Car/operation_info',['car_id'=>$info['car_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Car/update_status',['car_id'=>$info['car_id']]); ?>">
