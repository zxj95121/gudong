                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>场馆列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/UserCouponCon/index'); ?>" id='searchForm' method='get'>
                                    <select class="select_info chosen" data-with-diselect="1" name="user_no" data-placeholder="-请选择用户-" tabindex="1">
                                        ...
                                        <option value="<?php echo $user['user_no']; ?>" <?php if(isset($user_no)): if($user_no == $user['user_no']): ?>selected<?php endif; endif; ?>><?php echo $user['user_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $info['coupon_money']/100; ?>元</td>
