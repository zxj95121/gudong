...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/UserCoupon/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
            <div class="row-fluid" style="margin-top: 10px;">
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>会员优惠卷列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/UserCoupon/index'); ?>" id='searchForm' method='get'>

                                    <input type="number" name="coupon_no" class="m-wrap" placeholder="请输入优惠卷编号" value="<?php echo (isset($coupon_no) && ($coupon_no !== '')?$coupon_no:''); ?>">
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if(isset($status)): if($status == 1): ?>selected<?php endif; endif; ?>>未使用</option>
                                        <option value="2" <?php if(isset($status)): if($status == 2): ?>selected<?php endif; endif; ?>>已过期</option>
                                        <option value="3" <?php if(isset($status)): if($status == 3): ?>selected<?php endif; endif; ?>>已使用</option>
                                    </select>
                                    <!--<button type="submit" style="margin-bottom: 26px" class="btn green"><i class="icon-search"></i>搜索</button>-->
                                </form>
                            </div>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo date('Y-m-d',$info['start_time']); ?>--<?php echo date('Y-m-d',$info['end_time']); ?></td>
                                    <td><span><?php echo showstatus($info['from'],'自己,赠送:1,2'); ?></span></td>
                                    <td><span><?php echo date('Y-m-d H:i:s',$info['add_ts']); ?></span></td>
                                    <td>
                                        <span><?php echo showstatus($info['status'],'未使用,已过期,已使用:1,2,3'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/UserCoupon/update_status',['userCoupon_id'=>$info['userCoupon_id']]); ?>">
