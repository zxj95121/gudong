                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Arrange/payment'); ?>" id='searchForm' method='get'>
    ...
    <?php foreach($my_rule as $k=>$v): if($k==0): ?>
        ...
        <?php endif; endforeach; ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo showstatus($info['pay_type'],'微信:1'); ?></td>
                                    <td><?php echo $info['pay_no']; ?></td>
                                    <td><?php echo $info['price']/100; ?>元</td>
                                    <td><?php echo $info['rel_money']/100; ?>元</td>
                                    <td><?php echo date('Y-m-d H:i:s',$info['add_ts']); ?></td>
                                    <td><span><?php echo showstatus($info['status'],'成功,失败:1,2'); ?></span></td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
