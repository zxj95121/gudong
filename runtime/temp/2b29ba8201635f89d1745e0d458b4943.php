...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/RelStoreProject/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加关联</a>
            <div class="row-fluid" style="margin-top: 10px;">
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>项目门店关联列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/RelStoreProject/index'); ?>" id='searchForm' method='get'>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/RelStoreProject/operation_info',['rel_id'=>$info['rel_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/RelStoreProject/update_status',['rel_id'=>$info['rel_id']]); ?>">
