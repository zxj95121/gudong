<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\wamp64\www\gudong\public/../application/index\view\Default\index\momentShow.html";i:1510301175;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="fet">
        <?php foreach($momentList as $key=>$val): ?>
		<ul class="gtn">
			<li>
