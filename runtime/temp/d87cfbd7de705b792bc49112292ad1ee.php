...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/Type/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加信息</a>
            <div class="row-fluid" style="margin-top: 10px;">
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>商品类型列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Type/index'); ?>" id='searchForm' method='get'>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Type/operation_info',['type_id'=>$info['type_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Type/update_status',['type_id'=>$info['type_id']]); ?>">
