                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/Activity/index'); ?>" id='searchForm' method='get'>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td data-content="<?php echo htmlspecialchars($info['content']); ?>" class="showContent"><?php echo mb_substr(strip_tags(htmlspecialchars_decode($info['content'])),0,36,'utf-8'); ?></td>
                                    <td><?php echo date("Y-m-d",$info['add_ts']); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Activity/operation_info',['activity_id'=>$info['activity_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Activity/update_status',['activity_id'=>$info['activity_id']]); ?>">
