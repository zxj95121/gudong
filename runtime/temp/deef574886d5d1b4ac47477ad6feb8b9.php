                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/Arrange/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="control-group zwz" hidden="hidden">
                                ...
                                <div class="control-group zwz" >
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="number" readonly value="<?php echo $info['number']; ?>" name="number" class="numbers span2 m-wrap"
                                               placeholder="请输入人数">
                                ...
                                <div class="control-group hide xianjin zwz" hidden="hidden">
