                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>阶段列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/study/stage'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="chzn-container" style="float: left;margin-right: 15px;">
                                        <input type="text" maxlength="100" name="stage_name" value="<?php echo $stage_name; ?>" style="height:24px;font-size:12px;" placeholder="-科目名称-"/>
                                    </div>
                                    ...
                                    <div style="float:right;">
                                        <input type="button" onclick="editStage(0)" class="btn green" value="添　加"/>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <?php foreach($stageList as $key=>$stage): ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                           <span class="btn blue"  onclick="editStage(<?php echo $stage['stage_id']; ?>)" style="cursor: pointer;">
...
<script type="text/javascript">
    function editStage(stage_id){
        window.location.href = "<?php echo url('Study/editStage'); ?>?stage_id="+stage_id;
    }
</script>
    </div>
