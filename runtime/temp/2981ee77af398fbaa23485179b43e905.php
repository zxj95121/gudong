                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>项目信息列表</div>
                            <div class="tools">
                            ...
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/'.$controller_name.'/'.$action_name); ?>" id='searchForm' method='get'>
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="project_id" data-placeholder="-请选择项目-" tabindex="1">
                                        ...
                                        <option value="<?php echo $project['project_id']; ?>" <?php if(isset($project_id)): if($project_id == $project['project_id']): ?>selected<?php endif; endif; ?>><?php echo $project['project_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <select class="select_info chosen" data-with-diselect="1" name="type_id" data-placeholder="-请选择项目类型-" tabindex="1">
                                        <option value=""></option>
                                        <?php foreach($typeList as $type): ?>
                                        <option value="<?php echo $type['type_id']; ?>" <?php if(isset($type_id)): if($type_id == $type['type_id']): ?>selected<?php endif; endif; ?>><?php echo $type['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>

                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择状态-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if(isset($status)): if($status == 1): ?>selected<?php endif; endif; ?>>上架</option>
                                        <option value="2" <?php if(isset($status)): if($status == 2): ?>selected<?php endif; endif; ?>>下架</option>
                                    </select>

                                    <select class="select_info chosen" data-with-diselect="1" name="exchange_type" data-placeholder="-请选择兑换类型-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if(isset($exchange_type)): if($exchange_type == 1): ?>selected<?php endif; endif; ?>>正常</option>
                                        <option value="2" <?php if(isset($exchange_type)): if($exchange_type == 2): ?>selected<?php endif; endif; ?>>兑换</option>
                                    </select>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><span><?php echo showstatus($info['position_type'],'通用,床,沙发:0,1,2'); ?></span></td>
                                    <td><?php echo $info['usual_price']/100; ?>元</td>
                                    <td><?php echo $info['price']/100; ?>元</td>
                                    <td><?php echo $info['points']; ?></td>
                                    <td><?php echo $info['project_time']; ?></td>
                                    <td><?php echo $info['short_name']; ?></td>
                                    <td><?php echo $info['rest_time']; ?></td>
                                    <td><?php echo $info['sort']; ?></td>
                                    <td><span><?php echo showstatus($info['exchange_type'],'正常,兑换:1,2'); ?></span></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/Project/operation_info',['project_id'=>$info['project_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/Project/update_status',['project_id'=>$info['project_id'],'status'=>$info['status']]); ?>">
...
<script>
    ...
    $('.chosen[name="type_id"]').change(function () {
        return $('#searchForm').submit();
    })

    $('.chosen[name="exchange_type"]').change(function () {
        return $('#searchForm').submit();
    })
</script>