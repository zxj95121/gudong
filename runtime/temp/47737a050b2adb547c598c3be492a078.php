                ...
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>门店列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/store/info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="chzn-container" style="float: left;margin-right: 15px;">
                                        <input type="text" maxlength="100" name="store_name" value="<?php echo $store_name; ?>" style="height:24px;font-size:12px;" placeholder="-要查找门店-"/>
                                    </div>
                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-营业状态-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>营业</option>
                                        <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>休整</option>
                                    </select>
                                    <div style="float:right;">
                                        <input type="button" onclick="editStore(0)" class="btn green" value="添　加"/>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <?php foreach($storeList as $key=>$store): ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $store['tel_name']; ?></td>
                                        <td><?php echo $store['lng']; ?></td>
                                        <td><?php echo $store['lat']; ?></td>
                                        <td>
                                            <?php if(!empty($store['store_img'])): ?>
                                            <img src="<?php echo $store['store_img']; ?>">
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <span class="btn <?php if($store['status']==1): ?>green<?php else: ?>red<?php endif; ?>">
                                                <?php echo showStatus($store['status'],'营业,关闭:1,2'); ?>
                                            </span>
                                        </td>
                                        <td>
                                           <span class="btn blue"  onclick="editStore(<?php echo $store['store_id']; ?>)" style="cursor: pointer;">
...
<script type="text/javascript">
    function editStore(store_id){
        window.location.href = "<?php echo url('Store/editStore'); ?>?store_id="+store_id;
    }
</script>
    </div>
