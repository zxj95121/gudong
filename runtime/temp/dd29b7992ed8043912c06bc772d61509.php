<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"C:\wamp64\www\anmo\public/../application/admin\view\Default\Car\operation_info.html";i:1506415025;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\header.html";i:1506352460;s:75:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\nav.html";i:1505728701;s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\footer.html";i:1505728701;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑技师信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/Car/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="car_id" value="<?php echo (isset($info['car_id']) && ($info['car_id'] !== '')?$info['car_id']:''); ?>">
                                <input type="hidden" name="backUrl" value="<?php echo $backUrl; ?>">


                                <div class="control-group">
                                    <label class="control-label">司机姓名：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="<?php echo (isset($info['driver_name']) && ($info['driver_name'] !== '')?$info['driver_name']:''); ?>" name="driver_name" class="span6 m-wrap"
                                               placeholder="请输入司机姓名" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="<?php echo (isset($info['car_no']) && ($info['car_no'] !== '')?$info['car_no']:''); ?>" name="car_no" class="span6 m-wrap"
                                               placeholder="请输入车牌号码" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" value="<?php echo (isset($info['mobile']) && ($info['mobile'] !== '')?$info['mobile']:''); ?>" name="mobile" class="span6 m-wrap"
                                               placeholder="请输入手机号码" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="datetime-local" value="<?php if(isset($info)): ?><?php echo date('Y-m-d',$info['time']); ?>T<?php echo date('H:i',strtotime($info['time'])); endif; ?>" name="time" class="span6 m-wrap"
                                               placeholder="请输入预约时间" >
                                    </div>
                                </div>
                                <div class="control-group">
