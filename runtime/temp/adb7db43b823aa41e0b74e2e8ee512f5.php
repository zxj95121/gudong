...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td data-content="<?php echo $info['content']; ?>" class="showContent"><?php echo mb_substr($info['content'],0,10,'utf-8'); ?></td>
