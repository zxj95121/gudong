...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <!--<a href="<?php echo url('admin/User/operation_info'); ?>" class="btn green"><i class="icon-plus"></i>添加用户</a>-->
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/user/index'); ?>" id='searchForm' method='get'>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    <td><?php echo $key; ?></td>
                                    <td><?php echo $info['user_no']; ?></td>
                                    <td><?php echo $info['user_name']; ?></td>
                                    <td><?php echo $info['yanzhi']; ?></td>
                                    <td>
                                        <?php if(!empty($info['header_img'])): ?>
                                        <img src="<?php echo $info['header_img']; ?>" class="showImg" >
                                        <?php else: ?>
                                    ...
                                    <td><?php if(!empty($info['birthday'])): ?><?php echo date("Y-m-d",$info['birthday']); endif; ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/User/operation_info',['user_id'=>$info['user_id']]); ?>">修改</a></li>
                                                <li><a href="<?php echo url('admin/User/update_status',['user_id'=>$info['user_id']]); ?>">
