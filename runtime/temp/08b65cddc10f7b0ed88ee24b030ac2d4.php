<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"C:\wamp64\www\anmo\public/../application/admin\view\Default\Stock\operation_info.html";i:1507350130;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\header.html";i:1506495541;s:75:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\nav.html";i:1505728701;s:81:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\path_link.html";i:1505728701;s:78:"C:\wamp64\www\anmo\public/../application/admin\view\Default\common\footer.html";i:1505728701;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8" />
                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑门店沙发床位存量信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/Stock/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="stock_id" value="<?php echo (isset($info['stock_id']) && ($info['stock_id'] !== '')?$info['stock_id']:''); ?>">
                                ...
                                <div class="control-group">
                                    <label class="control-label">数　　量：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="number"  value="<?php echo (isset($info['num']) && ($info['num'] !== '')?$info['num']:''); ?>" name="num" class="m-wrap"
                                               placeholder="请输入数量" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="position_type" data-placeholder="-选择类型-" tabindex="1">
                                            <option value=""></option>
