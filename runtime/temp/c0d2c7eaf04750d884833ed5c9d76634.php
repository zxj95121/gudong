                ...
                <div class="span12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑快递订单信息</div>
                            <div class="tools">
                                <a href="javascript:void(0);" class="collapse"></a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo url('/admin/PointsOrder/save_info'); ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="order_id" value="<?php echo (isset($info['order_id']) && ($info['order_id'] !== '')?$info['order_id']:''); ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly value="<?php echo $info2['user_name']; ?>" name="user_name" class="span6 m-wrap"
                                                >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly value="<?php echo $info2['mobile']; ?>" name="mobile" class="span6 m-wrap"
                                                >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly value="<?php echo $info['address']; ?>" name="address" class="span6 m-wrap"
                                                >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" readonly value="<?php echo $info3['valueService_name']; ?>" name="valueService_name" class="span6 m-wrap"
                                                >
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" readonly value="<?php echo $info3['price']/100; ?>" name="price" class="span6 m-wrap"
                                                >
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label">　积　分：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="number" readonly value="<?php echo $info3['points']; ?>" name="points" class="span6 m-wrap"
                                                >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">　图　片：<span class="required">*</span></label>
                                    <div class="controls">
                                        <?php if(!empty($info3['img'])): ?>
                                        <img  src="<?php echo \think\Config::get('cms_upload'); ?>/<?php echo $info3['img']; ?>"  style="width:100px" name="img" class="showImg"/>
                                        <?php else: ?>
                                ...
                                <div class="control-group">
                                    <label class="control-label">快递名称：<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="express_id" data-placeholder="-请选择快递名称-" tabindex="1">
                                            <option value=""></option>
                                            <?php foreach($expressList as $express): ?>
                                            <option value="<?php echo $express['express_id']; ?>"  <?php if(!empty($info)): if($info['express_id'] == $express['express_id']): ?>selected<?php endif; endif; ?> ><?php echo $express['express_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">快递号码：<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="number" value="<?php echo (isset($info['express_no']) && ($info['express_no'] !== '')?$info['express_no']:''); ?>" name="express_no" class="span6 m-wrap"
                                               placeholder="请输入快递号码" >
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label">物流状态：<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="select_info chosen" data-with-diselect="1" name="express_status" data-placeholder="-选择物流状态-" tabindex="1">
                                            <option value=""></option>
                                            <option value="1" <?php if(isset($info)): if(1 == $info['express_status']): ?>selected<?php endif; endif; ?>>未发货</option>
                                            <option value="2" <?php if(isset($info)): if(2 == $info['express_status']): ?>selected<?php endif; endif; ?>>已发货</option>
                                        </select>
                                    </div>
                                </div>
