                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/GoodsOrder/index'); ?>" id='searchForm' method='get'>
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="status" data-placeholder="-请选择订单状态-" tabindex="1">
                                        ...
                                        <option value="2" <?php if(isset($status)): if($status == 2): ?>selected<?php endif; endif; ?>>已兑换</option>
                                    </select>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><span><?php echo showstatus($info['express_status'],'未发货,等待收货,已收货:1,2,3'); ?></span></td>
                                    <td><?php echo date('Y-m-d H:i:s',$info['add_ts']); ?></td>
                                    <td><span><?php echo showstatus($info['status'],'未兑换,已兑换:1,2'); ?></span></td>
                                    <td>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
