...
<div class="page-content">
    ...
    <div class="span12">
        ...
        <div id="dashboard">
            <a href="<?php echo url('admin/UserCharge/operation_info'); ?>" class="btn green"></i>添加会员充值记录</a>
            <div class="row-fluid" style="margin-top: 10px;">
                <div class="span12">
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>会员充值记录列表</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                ...
                                <form action="<?php echo url('admin/UserCharge/index'); ?>" id='searchForm' method='get'>
                                    ...
                                    <select class="select_info chosen" data-with-diselect="1" name="type" data-placeholder="-请选择充值类型-" tabindex="1">
                                        <option value=""></option>
                                        <option value="1" <?php if(isset($type)): if($type == 1): ?>selected<?php endif; endif; ?>>线上</option>
                                        <option value="2" <?php if(isset($type)): if($type == 2): ?>selected<?php endif; endif; ?>>线下</option>
                                    </select>
                                </form>
                            </div>
...
<tr>
    ...
    <th>操作</th>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $info['money']/100; ?>元</td>
                                    <td><?php echo showstatus($info['type'],'线上,线下:1,2'); ?></td>
                                    <td>
                                        <?php if(!empty($info['voucher'])): ?>
                                        <img src="<?php echo \think\Config::get('cms_upload'); ?><?php echo $info['voucher']; ?>" class="showImg" >
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="text-align: left">
                                                <li><a href="<?php echo url('admin/UserCharge/operation_info',['charge_id'=>$info['charge_id']]); ?>">修改</a></li>
                                                </li>
                                            </ul>
                                        </div>
                                        <?php endif; ?>
